...
class CommissionStatementView extends StatelessWidget {
  const CommissionStatementView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CommissionStatementController());
  ...
  Widget _buildMonthSelector(CommissionStatementController controller) {
  ...
  Widget _buildTotalCard(CommissionStatementController controller) {
    final totals = controller.commissionStatement.value!.totals;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 12),
          Text(
            '₹${totals.netCommission.toStringAsFixed(2)}',
            style: TextStyle(
              fontSize: 36,
          ...
          Container(
            ...
            child: Column(
              children: [
                _buildSummaryRow('Gross Commission', totals.totalGrossCommission),
                SizedBox(height: 8),
                _buildSummaryRow('TDS (5%)', totals.totalTds),
                SizedBox(height: 8),
                _buildSummaryRow('Slip Charge', totals.slipCharge),
              ],
            ),
          ),
        ],
  ...
  Widget _buildDailyDataList(CommissionStatementController controller) {
        ...
        Row(
          ...
          children: [
            ...
            if (dailyData.isNotEmpty)
              GestureDetector(
                onTap: () => controller.downloadCommissionPdf(),
                child: Container(
  ...
  void _showMonthPicker(CommissionStatementController controller) {
